...
def main():
    ...
    with open(args.output_dir, "a") as wp:
        ...
        for i, data in enumerate(dataloader):
            ...
            z = decoder.decode(args, demo, x, max_length)
...
def parse_arguments():
    ...
    parser.add_argument(
        "--model", type=str, default="gpt-3.5-turbo", choices=["gpt3", "gpt3-medium", "gpt3-large", "gpt3-xl", "code-davinci-002"], help="model used for decoding. Note that 'gpt3' are the smallest models."
    )
